        ...
        function interfaceObject(matchHandler) {
                    ...
                    switch (response.phase) {
                        case "suspend_charged_attack":
                            ...
                            $(".battle-window .animate-message .text").html(
                                "Hold to charge up " + activePokemon[0].chargedMoves[response.move].name + "!",
                            );
                            $(".switch-sidebar").removeClass("active");
                        ...
                        case "animating":
                            ...
                            if (phase == "suspend_charged_attack") {
                                var chargeMultiplier = Math.min(0.25 + 0.75 * (charge / maxCharge), 1);
                ...
                $(".battle-window .pokemon-container.animate-switch").each(function (index, value) {
                    ...
                    if (timePassed >= parseInt($(this).attr("animation-duration")) && activePokemon[index].hp > 0) {
                        ...
                        $(".team-indicator")
                            .eq(index)
                            .find(".cp")
                            .html("CP " + activePokemon[index].cp);
            ...
            this.reportBattleAnalytics = function (result) {
                var battleSummaryStr =
                    battle.getCup().name + " " + battle.getCP() + " difficulty " + (players[1].getAI().getLevel() + 1);
