    ...
    function createInstance() {
        ...
        function interfaceObject() {
            ...
            this.displayTimeline = function (b, bulkRatings, doRandomBulk, animate) {
                ...
                if (rating != 500) {
                    ...
                    $(".battle-results .summary").html(
                        '<div class="battle-summary-line"><span class="name">' +
                            pokemon[0].speciesName +
                            "</span> " +
                            description +
                            ' in <span class="time">' +
                            durationSeconds +
                            's</span> with a battle rating of <span class="rating"><span></span>' +
                            rating +
                            "</span></div>",
                    );
                    ...
                    $(".battle-results .summary").append(
                        '<div class="turn-margin-description"><span class="turn-margin" value="' +
                            attr +
                            '">' +
                            turnMarginDisplay +
                            "</span> of difference can flip this scenario. " +
                            marginSummary +
                            "</div>",
                    );
                ...
                if (bulkRatings) {
                    ...
                    $outcomes.append(
                        '<div class="outcome"><div class="outcome-label">Worst</div><a href="#" class="rating worst"><span></span>' +
                            worstRating +
                            "</a></div>",
                    );
                    ...
                    if (bulkResults.medianLoss && bulkResults.medianWin) {
                        ...
                        $outcomes.append(
                            '<div class="outcome"><div class="outcome-label">Median<br>Loss</div><a href="#" class="rating median-loss"><span></span>' +
                                medianLossRating +
                                "</a></div>",
                        );
                        $outcomes
                            .find(".rating.median-loss")
                            .css(
                                "background-color",
                                "rgb(" + medianLossColor[0] + "," + medianLossColor[1] + "," + medianLossColor[2] + ")",
                            );
                        $outcomes.find(".rating.median-loss").addClass(medianLossClass);
                    }

                    $outcomes.append(
                        '<div class="outcome"><div class="outcome-label">Median</div><a href="#" class="rating median"><span></span>' +
                            medianRating +
                            "</a></div>",
                    );
                    ...
                    if (bulkResults.medianLoss && bulkResults.medianWin) {
                        ...
                        $outcomes.append(
                            '<div class="outcome"><div class="outcome-label">Median<br>Win</div><a href="#" class="rating median-win"><span></span>' +
                                medianWinRating +
                                "</a></div>",
                        );
                        $outcomes
                            .find(".rating.median-win")
                            .css(
                                "background-color",
                                "rgb(" + medianWinColor[0] + "," + medianWinColor[1] + "," + medianWinColor[2] + ")",
                            );
                        $outcomes.find(".rating.median-win").addClass(medianWinClass);
                    }

                    $outcomes.append(
                        '<div class="outcome"><div class="outcome-label">Best</div><a href="#" class="rating best"><span></span>' +
                            bestRating +
                            "</a></div>",
                    );
                    ...
                    $outcomes
                        ...
                        .css(
                            "background-color",
                            "rgb(" + medianColor[0] + "," + medianColor[1] + "," + medianColor[2] + ")",
                        );
                    $outcomes
                        .find(".rating.worst")
                        .css(
                            "background-color",
                            "rgb(" + worstColor[0] + "," + worstColor[1] + "," + worstColor[2] + ")",
                        );
                    ...
                    $(".battle-results .bulk-summary").append(
                        '<div class="disclaimer">Above is a collection of outcomes if both Pokemon take random move and shield actions. Explore the best, worst, and average results. Due to each Pokemon\'s randomized behavior, results may change and may not always represent realistic scenarios. Pokemon are not guaranteed to use all available shields or energy.</div>',
                    );
                }
            ...
            this.generateMatchupDetails = function (battle, bulkResults) {
                ...
                $("select.breakpoint-move").append(
                    '<option value="' + pokemon[0].fastMove.moveId + '">' + pokemon[0].fastMove.name + "</option>",
                );

                for (var i = 0; i < pokemon[0].chargedMoves.length; i++) {
                    $("select.breakpoint-move").append(
                        '<option value="' +
                            pokemon[0].chargedMoves[i].moveId +
                            '">' +
                            pokemon[0].chargedMoves[i].name +
                            "</option>",
                    );
                }

                $("select.bulkpoint-move").append(
                    '<option value="' + pokemon[1].fastMove.moveId + '">' + pokemon[1].fastMove.name + "</option>",
                );

                for (var i = 0; i < pokemon[1].chargedMoves.length; i++) {
                    $("select.bulkpoint-move").append(
                        '<option value="' +
                            pokemon[1].chargedMoves[i].moveId +
                            '">' +
                            pokemon[1].chargedMoves[i].name +
                            "</option>",
                    );
                }
                ...
                var minimumCMPAttack = pokemon[1].stats.atk + 0.001;
                var guaranteedCMPAttack = pokemon[1].generateIVCombinations("atk", 1, 1)[0].atk + 0.001;
                ...
                if (maxCMPAttack > minimumCMPAttack) {
                    $(".stats-table.cmp .output").append(
                        '<tr class="toggle"><td>' +
                            Math.round(minimumCMPAttack * 100) / 100 +
                            "</td><td>" +
                            Math.round(guaranteedCMPAttack * 100) / 100 +
                    ...
                    $(".stats-table.cmp .output").append(
                        "<tr class=\"toggle\"><td>Can't win<br>CMP</td><td>Can't win<br>CMP</td><td>Can't win<br>CMP</td></tr>",
                    );
                }
                ...
                for (var i = 1; displayCycles < 3; i++) {
                    ...
                    if (targetCooldown > 0 && targetTurn > 0 && targetTurn % pokemon[0].fastMove.cooldown == 0) {
                        // If this turn is divisible by your Fast Move duration
                ...
                if (targetCooldown > 0) {
                    ...
                    pokemon[0].startCooldown == 1000 &&
                    pokemon[1].startCooldown == 0 &&
                    pokemon[0].fastMove.cooldown == pokemon[1].fastMove.cooldown &&
                ...
                if (
                    $(".optimal-timing-section .timeline").eq(0).find(".chunk").length <
                    $(".optimal-timing-section .timeline").eq(1).find(".chunk").length
                ) {
                    $fastItem = $('<div class="item fast fade"><div class="chunk"></div></div>');
                    $fastItem.css("flex", 1);
                    $(".optimal-timing-section .timeline").eq(0).append($fastItem);
            ...
            this.displayBreakpoints = function (move) {
                ...
                for (var i = breakpoints.length - 1; i >= 0; i--) {
                    ...
                    var combinations = attacker.generateIVCombinations("overall", 1, 2, [
            ...
            this.displayBulkpoints = function (move) {
                ...
                for (var i = 0; i < bulkpoints.length; i++) {
                    ...
                    // Find the best combinations that reaches this value
                    var combinations = defender.generateIVCombinations("overall", 1, 2, [
            ...
            this.generateMultiBattleResults = function () {
                ...
                for (var i = 0; i < rankings.length; i++) {
                    ...
                    if (
                        ...
                        pokemon.startHp != pokemon.stats.hp ||
                        poke.startEnergy != 0 ||
                    ...
                    var $el = $(
                        '<div class="rank ' +
                            ...
                            pokemon.speciesName +
                            '</span></div><div class="rating-container"><a class="rating" target="_blank" href="' +
                            battleLink +
                            '"><span></span>' +
                            r.opRating +
                            '<i></i></span></a><div class="clear"></div></div><div class="details"></div>',
                    );
                    ...
                    $el.find(".rating").css(
                        "background",
                        "rgb(" + ratingColor[0] + "," + ratingColor[1] + "," + ratingColor[2] + ")",
                    );
                ...
                if (
                    settings.startStatBuffs[0] != defaultSettings.startStatBuffs[0] ||
                    settings.startStatBuffs[1] != defaultSettings.startStatBuffs[1]
                ) {
            ...
            this.displayMatrixResults = function (rankings) {
                ...
                for (var i = 0; i < rankings.length; i++) {
                    ...
                    $differenceRow.append(
                        $('<td class="differences"><div class="wins"></div><div class="losses"></div></td>'),
                    );
                    ...
                    for (var n = 0; n < r.matchups.length; n++) {
                        ...
                        if (
                            pokemon.startHp != pokemon.stats.hp ||
                            opponent.startHp != opponent.stats.hp ||
                            pokemon.startEnergy != 0 ||
                    ...
                    if (self.matrixMode == "battle") {
                        ...
                        var $cell = $(
                            '<td><a class="rating ' +
                                ratingClass +
                                ' average" target="blank"><span></span>' +
                                displayAverage +
                                "</a></td>",
                        );
                    ...
                    differenceMatchups.sort((a, b) =>
                        a.difference > b.difference ? -1 : b.difference > a.difference ? 1 : 0,
                    );
                        ...
                        if (differenceMatchups[n].difference) {
                            var $difference = $(
                                '<a href="#" class="difference ' +
                                    differenceMatchups[n].difference +
                                    '" matchup-index="' +
                                    differenceMatchups[n].matchupIndex +
                                    '">' +
                                    differenceMatchups[n].opponent.speciesName +
                                    "<br><span>" +
                                    differenceMatchups[n].opponent.generateMovesetStr() +
                                    "</span></a>",
                            );
                    ...
                    if (
                        i > 0 &&
                        $differenceRow.find(".wins a").length == 0 &&
                        $differenceRow.find(".losses a").length == 0
                    ) {
                ...
                // Update download link with new data
                var filename =
                    multiSelectors[0].getSelectedGroup() + " vs " + multiSelectors[1].getSelectedGroup() + ".csv";
                var filedata = "";
            ...
            function jumpToMatrixColumn(e) {
                ...
                var tableGotoOffset =
                    $(".matrix-table.rating-table").parent().scrollLeft() +
                    $(".matrix-table.rating-table thead th").eq(matchupIndex).position().left -
                    theadWidth -
                    20;
                ...
                $("html, body").animate(
                    { scrollTop: $(".battle-results .matrix-table.rating-table").offset().top - 185 },
                    500,
                );
            }
                        ...
                        switch (key) {
                            ...
                            case "cp":
                                ...
                                if (val.indexOf("-") > -1) {
                                    ...
                                    $('.league-select option[value="' + getCP + '"][level-cap="' + getCap + '"]').prop(
                                        "selected",
                                        "selected",
                                    );
                                } else {
                            ...
                            case "cup":
                                $('.cup-select option[value="' + val + '"][cp="' + battle.getCP() + '"]').prop(
                                    "selected",
                                    "selected",
                                );
            ...
            function moveBarHover(e) {
                ...
                displayDamage = battle.calculateDamageByStats(
                    subject,
                    target,
                    subject.getEffectiveStat(0, true),
                    target.getEffectiveStat(1, true),
                    effectiveness,
                    move,
                );
                ...
                if (selectedIndex > 0) {
                    ...
                    if (!sandboxAction) {
                        ...
                        if (selectedValue != "wait") {
                            ...
                            actions.push(
                                new TimelineAction("charged", sandboxPokemon.index, sandboxTurn, selectedIndex - 1, {
