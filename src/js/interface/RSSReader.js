...
var RSS = (function () {
    ...
    function createInstance() {
        ...
        object.generateItemHTML = function (item) {
            ...
            $html
                .find(".news-date")
                .html(item.pubDate.toLocaleDateString("en-US", { weekday: "short", month: "short", day: "numeric" }));
        ...
        object.displayHeader = function () {
            ...
            $(".latest-section .date").html(
                item.pubDate.toLocaleDateString("en-US", { weekday: "short", month: "short", day: "numeric" }),
            );
