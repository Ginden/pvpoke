    ...
    this.generate = function (pokemon, ratings, scaleOverride) {
        ...
        var $histogram = $(
            "<div><h2>" +
                ...
                moveStr +
                '</div><div class="chart"></div><div class="x-axis"><div>0</div><div>500</div><div>1000</div></div><div class="label label-y-axis">Battle Rating (Avg: <span class="br-avg">500</span>)</div><div class="label-x-axis">Matches</div><div class="button previous">See Previous</div><div class="stats"></div></div>',
        );
