        ...
        function interfaceObject() {
            ...
            this.displayChecklist = function (list, sort) {
                ...
                for (var i = 0; i < list.length; i++) {
                    ...
                    $el.find(".iv-bar .bar")
                        .eq(0)
                        .width((item.ivs[1] / 15) * 100 + "%");
                    $el.find(".iv-bar .bar")
                        .eq(1)
                        .width((item.ivs[2] / 15) * 100 + "%");
                    $el.find(".iv-bar .bar")
                        .eq(2)
                        .width((item.ivs[3] / 15) * 100 + "%");
                    ...
                    $el.find(".base-form-section .cp-item")
                        .eq(0)
                        .find(".cp")
                        .html("CP " + baseCP);
                    $el.find(".base-form-section img").attr(
                        "src",
                        "../../article-assets/community-day/base/" + item.speciesId + ".png",
                    );
            ...
            $("body").on("click", ".checklist-item a.info", function (e) {
                ...
                notes = notes.replace(/(^|\s)([0-9.]*\sAttack)(|$)/gi, "$1<b>$2</b>$3");
                notes = notes.replace(/(^|\s)([0-9.]*\sDefense)(|$)/gi, "$1<b>$2</b>$3");
                notes = notes.replace(/(^|\s)([0-9.]*\sHP)(|$)/gi, "$1<b>$2</b>$3");
