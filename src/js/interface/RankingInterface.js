        ...
        function interfaceObject() {
            ...
            this.displayRankingData = function (rankings) {
                ...
                switch (sort) {
                    ...
                    case "statproduct":
                        data.sort((a, b) =>
                            a.stats.product > b.stats.product ? -1 : b.stats.product > a.stats.product ? 1 : 0,
                        );
            ...
            this.displayRankingEntry = function (r, index) {
                    ...
                    if (n == 0) {
                        for (var j = 0; j < pokemon.fastMovePool.length; j++) {
                            if (r.moveset[n] == pokemon.fastMovePool[j].moveId) {
                                ...
                                moveNameStr +=
                                    '<span class="count fast">' + pokemon.fastMovePool[j].cooldown / 500 + "</span>";
                                break;
                            }
                        }
                    } else {
                        for (var j = 0; j < pokemon.chargedMovePool.length; j++) {
                            if (r.moveset[n] == pokemon.chargedMovePool[j].moveId) {
                                ...
                                var moveCounts = Pokemon.calculateMoveCounts(
                                    pokemon.fastMove,
                                    pokemon.chargedMovePool[j],
                                );
                ...
                var $el = $(
                    '<div class="rank ' +
                        ...
                        moveNameStr +
                        '</div></div><div class="rating-container"><div class="rating score-rating">' +
                        r.score +
                ...
                if (battle.getCup().slots) {
                    ...
                    for (var n = 0; n < battle.getCup().slots.length; n++) {
                        ...
                        if (
                            slot.pokemon.indexOf(pokemon.speciesId) > -1 ||
                ...
                if (battle.getCup().slots) {
                    ...
                    for (var n = 0; n < slots.length; n++) {
                        if (
                            slots[n].pokemon.indexOf(pokemon.speciesId) > -1 ||
                            slots[n].pokemon.indexOf(pokemon.speciesId.replace("_shadow", "")) > -1
                        ) {
                ...
                csv +=
                    ...
                    "," +
                    Math.round(pokemon.stats.def * 10) / 10 +
                    "," +
                    Math.round(pokemon.stats.hp) +
                    "," +
                    Math.round(pokemon.stats.atk * pokemon.stats.def * pokemon.stats.hp) +
                    "," +
                    pokemon.level +
                    "," +
                    pokemon.cp +
                        ...
                        switch (key) {
                            ...
                            case "cat":
                                ...
                                if ($('.category-select option[sort="' + val + '"]').length > 0) {
                                    $('.category-select option[sort="' + val + '"]')
                                        .first()
                                        .prop("selected", "selected");
                                } else {
                                    $('.category-select option[value="' + val + '"]')
                                        .first()
                                        .prop("selected", "selected");
                                }
            ...
            function selectPokemon(e) {
                ...
                if (
                    ...
                    $(e.target).is("a") ||
                    $(e.target).is(".detail-section div, .detail-section span")
                ) {
                    return;
                }
                ...
                $details
                    .find(".stat-details .stat-row .value")
                    .eq(0)
                    .html(Math.floor(pokemon.stats.atk * 10) / 10);
                $details
                    .find(".stat-details .stat-row .value")
                    .eq(1)
                    .html(Math.floor(pokemon.stats.def * 10) / 10);
                ...
                $details
                    .find(".stat-details .stat-row .bar:first-of-type")
                    .eq(0)
                    .css("width", ((pokemon.stats.atk - statSubtraction) / statCeiling) * 100 + "%");
                $details
                    .find(".stat-details .stat-row .bar:first-of-type")
                    .eq(1)
                    .css("width", ((pokemon.stats.def - statSubtraction) / statCeiling) * 100 + "%");
                $details
                    .find(".stat-details .stat-row .bar:first-of-type")
                    .eq(2)
                    .css("width", ((pokemon.stats.hp - statSubtraction) / statCeiling) * 100 + "%");
                $details
                    .find(".stat-details .stat-row .bar:first-of-type")
                    .eq(3)
                    .css("width", ((overall - statProductSubstraction) / statProductCeiling) * 100 + "%");
                ...
                for (var n = 0; n < fastMoves.length; n++) {
                    ...
                    $moveDetails
                        ...
                        .html(
                            Math.round(
                                ((fastMoves[n].power * fastMoves[n].stab * pokemon.shadowAtkMult) /
                                    (fastMoves[n].cooldown / 500)) *
                                    100,
                            ) / 100,
                        );
                    $moveDetails
                        .find(".ept .value")
                        .html(Math.round((fastMoves[n].energyGain / (fastMoves[n].cooldown / 500)) * 100) / 100);
                ...
                for (var n = 0; n < chargedMoves.length; n++) {
                    ...
                    $moveDetails
                        .find(".damage .value")
                        .html(
                            Math.round(chargedMoves[n].power * chargedMoves[n].stab * pokemon.shadowAtkMult * 100) /
                                100,
                        );
                    ...
                    $moveDetails
                        ...
                        .html(
                            Math.round(
                                ((chargedMoves[n].power * chargedMoves[n].stab * pokemon.shadowAtkMult) /
                                    chargedMoves[n].energy) *
                                    100,
                            ) / 100,
                        );
                    ...
                    $moveDetails
                        .find(".move-count span")
                        .html(moveCounts[0] + " - " + moveCounts[1] + " - " + moveCounts[2] + " - " + moveCounts[3]);
                ...
                for (var n = 0; n < r.matchups.length; n++) {
                    ...
                    var $item = $(
                        '<div class="rank ' +
                            ...
                            '</span></div><div class="rating-container"><a target="_blank" href="' +
                            battleLink +
                            '" class="rating"><span></span>' +
                            m.rating +
                            '<i></i></a><div class="clear"></div></div>',
                    );
                ...
                for (var n = 0; n < r.counters.length; n++) {
                    ...
                    var $item = $(
                        '<div class="rank ' +
                            ...
                            '" class="rating"><span></span>' +
                            c.rating +
                            '</span><i></i></a><div class="clear"></div></div>',
                    );
                ...
                for (var i = 0; i < effectivenessArr.length; i++) {
                    ...
                    if (effectivenessArr[i].val > 1) {
                        $details
                            .find(".detail-section .weaknesses")
                            .append(
                                '<div class="type ' +
                                    effectivenessArr[i].type +
                                    '"><div class="multiplier">x' +
                                    num +
                                    "</div><div>" +
                                    effectivenessArr[i].type +
                                    "</div></div>",
                ...
                for (var i = effectivenessArr.length - 1; i >= 0; i--) {
                    ...
                    if (effectivenessArr[i].val < 1) {
                        $details
                            .find(".detail-section .resistances")
                            .append(
                                '<div class="type ' +
                                    effectivenessArr[i].type +
                                    '"><div class="multiplier">x' +
                ...
                for (var i = 0; i < traits.pros.length; i++) {
                    $details
                        .find(".traits")
                        .append(
                            '<div class="pro" title="' + traits.pros[i].desc + '">+ ' + traits.pros[i].trait + "</div>",
                        );
                }
                ...
                for (var i = 0; i < traits.cons.length; i++) {
                    $details
                        .find(".traits")
                        .append(
                            '<div class="con" title="' + traits.cons[i].desc + '">- ' + traits.cons[i].trait + "</div>",
                        );
                }
                ...
                if (gm.rankings[key] && context != "custom" && !settings.performanceMode) {
                    setTimeout(function () {
                        ...
                        for (var i = 0; i < partnerPokemon.length; i++) {
                            if (
                                usedPartnerSpecies.indexOf(partnerPokemon[i].dex) == -1 &&
                                partnerPokemon[i].dex != pokemon.dex
                            ) {
                                ...
                                var teamURL =
                                    ...
                                    pokeMoveStr +
                                    "," +
                                    partnerPokemon[i].speciesId +
                                    "-m-" +
                                    partnerPokemon[i].generateURLMoveStr();

                                $details
                                    .find(".partner-pokemon .list")
                                    .append(
                                        '<a href="' +
                                            teamURL +
                                            '" target="blank" class="' +
                                            partnerPokemon[i].types[0] +
                                            '" data="' +
                                            partnerPokemon[i].speciesId +
                                            '">' +
                                            partnerPokemon[i].speciesName +
                                            " &rarr;</a>",
                                    );
                ...
                if (gm.rankings[key] && context != "custom" && !settings.performanceMode) {
                    ...
                    setTimeout(function () {
                        ...
                        for (var i = 0; i < 8; i++) {
                            $details
                                .find(".similar-pokemon .list")
                                .append(
                                    '<a href="#" class="' +
                                        similarPokemon[i].types[0] +
                                        '" data="' +
                                        similarPokemon[i].speciesId +
                                        '">' +
                                        similarPokemon[i].speciesName +
                                        "</a>",
                                );
                        }
                    }, 50);
            ...
            function drawRatingHexagon($rank, source, compare) {
                ...
                hexagon.draw(
                    [
                        Math.max((scores[0] - 30) / 70, 0.05),
                        Math.max((scores[2] - 30) / 70, 0.05),
                        Math.max((scores[3] - 30) / 70, 0.05),
                        Math.max((scores[1] - 30) / 70, 0.05),
                        Math.max((scores[5] - 30) / 70, 0.05),
                        Math.max((scores[4] - 30) / 70, 0.05),
                    ],
                    bgStr,
                    false,
                );
                ...
                if (compare) {
                    ...
                    hexagon.draw(
                        [
                            Math.max((compare.scores[0] - 30) / 70, 0.05),
                            Math.max((compare.scores[2] - 30) / 70, 0.05),
                            Math.max((compare.scores[3] - 30) / 70, 0.05),
                            Math.max((compare.scores[1] - 30) / 70, 0.05),
                            Math.max((compare.scores[5] - 30) / 70, 0.05),
                            Math.max((compare.scores[4] - 30) / 70, 0.05),
                        ],
                        compareStr,
                        true,
                    );
            ...
            function generatePartnerPokemon(pokemon, counters) {
                ...
                for (var i = 0; i < metaGroup.length; i++) {
                    ...
                    if (battle.getCup().tierRules) {
                        var remainingPoints =
                            battle.getCup().tierRules.max - gm.getPokemonTier(pokemon.speciesId, battle.getCup());
                ...
                metaGroup.sort((a, b) =>
                    a.partnerScore > b.partnerScore ? -1 : b.partnerScore > a.partnerScore ? 1 : 0,
                );
            ...
            function addPokemonToCompare(e) {
                ...
                $(".modal-content").append(
                    '<div class="center"><div class="save-poke button">Compare Pokemon</div></div>',
                );
                ...
                $(".modal .save-poke").on("click", function (e) {
                    ...
                    for (var i = 0; i < 6; i++) {
                        ...
                        $rank
                            .find(".chart-label .comparison")
                            .eq(i)
                            .css("background", "rgb(" + color[0] + "," + color[1] + "," + color[2] + ")");
