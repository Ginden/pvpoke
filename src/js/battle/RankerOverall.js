            ...
            this.displayRankingData = function () {
                ...
                for (var i = 0; i < rankings.length; i++) {
                    ...
                    rankings[i].score = Math.pow(
                        Math.pow(sortedScores[0], 12) *
                            Math.pow(sortedScores[1], 6) *
                            Math.pow(sortedScores[2], 4) *
                    ...
                    if (scores[4] <= 75 && consistencyScore <= 75) {
                        rankings[i].score = Math.pow(
                            Math.pow(rankings[i].score, 14) * Math.pow(scores[4], 1) * Math.pow(consistencyScore, 1),
                            1 / 16,
                        );
                    }
