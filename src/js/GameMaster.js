    ...
    function createInstance(interface) {
        ...
        object.setLevelCapData = function () {
            ...
            $.each(object.data.pokemon, function (index, poke) {
                ...
                if (
                    (pokemon.hasTag("legendary") || pokemon.hasTag("mythical")) &&
                    levelCapExclusion.indexOf(pokemon.speciesId) == -1
                ) {
                    entry.levelCap = 40;
                }
            });
                ...
                if (m.moveId == id) {
                    ...
                    if (m.buffs) {
                        ...
                        if (
                            ...
                            move.buffApplyChance >= 0.5 &&
                            move.moveId != "DRAGON_ASCENT" &&
        ...
        object.generateFilteredPokemonList = function (
            ...
            for (var i = 0; i < object.data.pokemon.length; i++) {
                ...
                if (
                    ...
                    if (
                        pokemon.hasTag("duplicate1500") &&
                        (battle.getCP() != 1500 ||
                            (battle.getCup().name != "all" &&
                                battle.getCup().name != "retro" &&
                                battle.getCup().name != "halloween"))
                    ) {
                        continue;
                    }
                        ...
                        for (var j = 0; j < filters.length; j++) {
                            ...
                            switch (filter.filterType) {
                                ...
                                case "id":
                                    ...
                                    if (
                                        filter.values.indexOf(testId) > -1 ||
                                        filter.values.indexOf(pokemon.speciesId) > -1
                                    ) {
                ...
                for (const pokemon of object.getAllPokemon(battle)) {
                    ...
                    for (var j = 0; j < params.length; j++) {
                        ...
                        if (param.charAt(0) == "+" && param.length > 2) {
                            ...
                            if (
                                searchPokemon &&
                                searchPokemon.family &&
                                pokemon.family &&
                                searchPokemon.family.id == pokemon.family.id
                            ) {
                                valid = true;
                            }
                        }
                        ...
                        if (param.charAt(0) == "@" && param.length > 2) {
                            ...
                            if (param == "meta") {
                                if (object.groups[metaKey] !== undefined) {
                                    ...
                                    for (k = 0; k < group.length; k++) {
                                        if (
                                            pokemon.speciesId.replace("_shadow", "") ==
                                            group[k].speciesId.replace("_shadow", "")
                                        ) {
                                            valid = true;
                                        }
                                    }
                            ...
                            if (
                                object.data.pokemonTraits.pros.indexOf(param) > -1 ||
                                object.data.pokemonTraits.cons.indexOf(param) > -1
                            ) {
                                pokemon.initialize(true);
